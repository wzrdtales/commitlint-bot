...
async function commitlint(context) {
  ...
  return paginate(pullRequests.getCommits(pull), async ({ data }) => {
    ...
    await repos.createStatus({
      ...
      target_url: report.valid
        ? undefined
        : "https://github.com/conventional-changelog/conventional-changelog/tree/8fb86d39cc9bf9d54e4bf5135a87b15a7c02dc25/packages/conventional-changelog-angular"
    });
